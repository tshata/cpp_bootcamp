...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/06/08 17:04:33 by tshata            #+#    #+#             */
/*   Updated: 2019/06/08 17:26:41 by tshata           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void) {
    ...
    FragTrap player1("Kunene");

    srand((unsigned int) time(NULL));

    {

        FragTrap player2("Tsepo");
    ...
    ScavTrap splayer1("kakashi");

    {
        ScavTrap splayer2("Sasuke");
