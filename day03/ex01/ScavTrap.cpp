...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/06/08 17:06:18 by tshata            #+#    #+#             */
/*   Updated: 2019/06/08 17:27:02 by tshata           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap(ScavTrap const &obj) : _hit_points(100), _max_hit_points(100), _energy_points(100),
    ...
    *this = obj;
    std::cout << "SC4V-TP: Stop, "
              << this->getName()
              << "! I have been chosen to guard this place, whoever enters shall have to go through me --"
              << std::endl;
}
