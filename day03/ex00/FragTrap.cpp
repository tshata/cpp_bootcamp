...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/06/08 16:26:37 by tshata            #+#    #+#             */
/*   Updated: 2019/06/08 17:16:15 by tshata           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void FragTrap::vaulthunter_dot_exe(std::string const &target) {
    const std::string attacks[3] = {
            "uses knife","shits","self destructs"
    };
